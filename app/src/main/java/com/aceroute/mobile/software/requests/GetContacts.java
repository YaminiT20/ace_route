 ...
 */
public class GetContacts extends RequestObject implements Parcelable{
        ...
        public static final Creator<GetContacts> CREATOR = new Creator<GetContacts>() {
            public GetContacts createFromParcel(Parcel source) {
                GetContacts cusCont = new GetContacts();
            ...
            @Override
            public GetContacts[] newArray(int size) {
